...
Update source folder to latest state in remote repository. The option is disabled by default.
...
By default `contrib` module is configured (but not included) with the following default values:
